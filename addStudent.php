...
include 'Controller/addStudent_core.php';
?>
<div>
    <div>
        <h1>Add Student</h1>
    ...
    <section>
        <form action="addStudent.php" onsubmit="return formValidate();" method="POST">
            <div>
                <label>Name</label>
...
<!--                     <input type="button" value="Add Student" onclick="formValidate()">
