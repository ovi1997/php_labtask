...
include 'Controller/addAccountant_core.php';
?>
<div>
    <div>
    ...
    <section>
        <form action="addAccountant.php" onsubmit="return formValidate();" method="POST">
            <div>
                <label>Name</label>
            ...
            <div>
                ...
                <input type="hidden" name="action" value="addAccountant">
                <div>
